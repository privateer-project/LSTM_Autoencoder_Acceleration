...
// *************************************************
//       Sigmoid Activation using hls_math.h
// *************************************************
template<class data_T, class res_T, typename CONFIG_T>
void  sigmoid_hls(data_T data[CONFIG_T::n_in], res_T res[CONFIG_T::n_in])
{
    if (CONFIG_T::io_type == io_parallel){
        #pragma HLS PIPELINE
    }
    ...
    for (int ii=0; ii<CONFIG_T::n_in; ii++) {
        ...
        res[ii] = (res_T) ((data_T)1.0 / ((data_T)1.0 + hls::exp(-datareg)));
    }
}
...
// *************************************************
//       TanH Activation using hls_math.h
// *************************************************
template<class data_T, class res_T, typename CONFIG_T>
void  tanh_hls(data_T data[CONFIG_T::n_in], res_T res[CONFIG_T::n_in])
{
    if (CONFIG_T::io_type == io_parallel){
        #pragma HLS PIPELINE
    }
